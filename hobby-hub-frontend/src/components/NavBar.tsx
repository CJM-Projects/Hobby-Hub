  ...
  return (
    <nav className="sticky top-0 z-50 bg-white shadow-sm">
      ...
      <div className="mx-4 hidden h-20 items-center md:flex">
        <div>
          <Link to="/" className="flex flex-nowrap items-center gap-1">
            <img
        ...
        <div className="flex flex-1 items-center justify-end gap-8">
          ...
          >
            ...
            <div
              className={`absolute left-0 top-full z-10 mt-3 w-48 rounded-xl border border-zinc-100 bg-white p-2 shadow-lg transition-all duration-200 ${
                desktopBrowseOpen
                  ? "visible opacity-100"
                  : "invisible opacity-0"
              }`}
      ...
      <div
        className={`fixed left-0 top-20 z-50 h-[calc(100vh-5rem)] w-72 overflow-y-auto bg-white p-6 shadow-xl transition-transform duration-300 md:hidden ${
