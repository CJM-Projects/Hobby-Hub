            ...
            <div className="bg-zinc-100 py-4">
                ...
                <div className="mx-auto max-w-6xl px-20 py-2">
                    <p>
                        ...
                        <a href="https://github.com/CJM-Projects/Hobby-Hub" target="_blank" rel="noopener noreferrer" className="underline hover:no-underline text-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-600 rounded">
                            GitHub Repository
                        </a>
                    </p>
                </div>
