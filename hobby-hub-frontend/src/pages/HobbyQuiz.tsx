  ...
  questions: [
    {
      ...
      answers: [
        {
          emoji: "🛋",
          text: "Not moving unless snacks are involved",
          score: 1,
        },
        { emoji: "🚶", text: "A gentle stroll, maybe", score: 2 },
        {
          emoji: "🚲",
          text: "Some light movement, nothing too hard",
          score: 3,
        },
        ...
        {
          emoji: "🏔️",
          text: "I want to feel it in my legs tomorrow",
          score: 6,
        },
      ],
    },
    {
      question:
        "You just got a blank canvas (literal or metaphorical). What happens?",
      image: creativeImg,
      ...
      answers: [
        ...
        {
          emoji: "🧩",
          text: "I follow a template, maybe tweak a little",
          score: 2,
        },
        { emoji: "🎨", text: "I mix a template with my own ideas", score: 3 },
        {
          emoji: "🖌️",
          text: "I start with an idea and improvise the rest",
          score: 4,
        },
        { emoji: "💡", text: "I throw out the rulebook early", score: 5 },
        {
          emoji: "🔥",
          text: "The canvas fears me, I am flowing with creativity",
          score: 6,
        },
      ],
    },
    {
      ...
      category: "relaxing",
      answers: [
        { emoji: "🧘", text: "As zen as possible", score: 6 },
    ...
    },
    {
      ...
      answers: [
        {
          emoji: "🙅",
          text: "Absolutely not, this is a solo mission",
          score: 1,
        },
        {
          emoji: "🚪",
          text: "I'd rather not, but I'm polite about it",
          score: 2,
        },
    ...
    {
      question: "You come across a problem. What's your first move?",
      image: strategicImg,
      ...
      answers: [
        ...
        {
          emoji: "🧠",
          text: "A bit of both - feel it out, then think",
          score: 3,
        },
        { emoji: "📝", text: "Jot down a rough plan", score: 4 },
        {
          emoji: "📊",
          text: "Break it into steps and troubleshoot properly",
          score: 5,
        },
        {
          emoji: "🔬",
          text: "Build a system so this never happens again",
          score: 6,
        },
      ],
    },
    {
      ...
      answers: [
        {
          emoji: "🆓",
          text: "I'll use whatever's already lying around",
          score: 1,
        },
    ...
    {
      question: "How much time are you willing to commit to this hobby?",
      image: timeImg,
      altText: "An hourglass placed on a calendar",
      category: "timeCommitment",
      answers: [
        { emoji: "💔", text: "I will try it once", score: 1 },
        { emoji: "📅", text: "Every now and then", score: 2 },
        {
          emoji: "🔁",
          text: "A regular date, once or twice a month",
          score: 3,
        },
        { emoji: "❤️", text: "I would like to do this once a week", score: 4 },
        {
          emoji: "💍",
          text: "Everyday please",
          score: 5,
        },
      ],
    },
